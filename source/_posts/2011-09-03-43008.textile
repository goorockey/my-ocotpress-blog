...
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 1:</span> VOID BaseThreadStart(PTHREAD_START_ROUTINE pfnStartAddr,PVOID pvParam){% endcodeblock %}
&nbsp;
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 2:</span> {{% endcodeblock %}
&nbsp;
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 3:</span> __try{% endcodeblock %}
&nbsp;
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 4:</span> {{% endcodeblock %}
&nbsp;
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 5:</span> ExitThread((pfnStartAddr)(pvParam));{% endcodeblock %}
&nbsp;
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 6:</span> }{% endcodeblock %}
&nbsp;
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 7:</span> __except(UnhandledExceptionFilter(GetExceptionInformation())){% endcodeblock %}
&nbsp;
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 8:</span> {{% endcodeblock %}
&nbsp;
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 9:</span> ExitProcess(GetExceptionCode());{% endcodeblock %}
&nbsp;
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 10:</span> }{% endcodeblock %}
&nbsp;
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 11:</span><span style="color: #008000;">//NOTE: We never get here. </span>{% endcodeblock %}
&nbsp;
<pre style="text-align: left; line-height: 12pt; margin: 0em; width: 100%; font-family: ; color: black; overflow: visible; padding: 0px;"><span style="color: #606060;"> 12:</span> }{% endcodeblock %}
&nbsp;
